...
var CI360Viewer = function () {
  ...
  _createClass(CI360Viewer, [{
    key: 'hasClickedOnHotspot',
    value: function hasClickedOnHotspot(mouse) {
      var _this = this;
      ...
      this.Hotspots.forEach(function (_ref) {
        var XPos = _ref.XPos,
            MarkID = _ref.MarkID,
            frame = _ref.frame,
            YPos = _ref.YPos,
    ...
    value: function onFirstImageLoaded(event) {
      ...
      divNova.innerHTML = '<div class="modal-dialog shadow-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span class="close">&times;</span></button></div><div class="modal-body d-flex align-items-center justify-content-center"><img id="img-start" src=""></div></div></div>';
    ...
    key: 'getSrc',
    value: function getSrc(responsive, container, folder, filename, _ref2) {
      var ciSize = _ref2.ciSize,
          ciToken = _ref2.ciToken,
          ciOperation = _ref2.ciOperation,
          ciFilters = _ref2.ciFilters;
      ...
      if (this.imageList) {
        try {
          ...
          images.forEach(function (src, index) {
            ...
            _this5.addImage(resultSrc, lazyload, lazySelector, index);
          });
        } catch (error) {
    ...
    value: function initControls() {
      ...
      var closeModalDiv = function closeModalDiv(event) {
        if (event.target.className == "close") {
          var closeButton = document.getElementById('modalMark');
      ...
      var onLeftStart = function onLeftStart(event) {
        ...
        _this6.onSpin();
        _this6.prev();
        _this6.loopTimeoutId = window.setInterval(_this6.prev.bind(_this6), _this6.autoplaySpeed);
      };
      var onRightStart = function onRightStart(event) {
        event.stopPropagation();
        _this6.onSpin();
        _this6.next();
        _this6.loopTimeoutId = window.setInterval(_this6.next.bind(_this6), _this6.autoplaySpeed);
      };
    ...
    value: function addMarks(marks) {
      ...
      if (marks != null) {
        var marksArray = JSON.parse(marks);
        if (marksArray.length) {
          marksArray.forEach(function (_ref3) {
            var XPos = _ref3.XPos,
                YPos = _ref3.YPos,
                frame = _ref3.frame,
                ID = _ref3.ID,
            ...
            var hotspot = new _this7.HotspotDraw();
            hotspot.XPos = XPos;
            hotspot.YPos = YPos;
            hotspot.frame = frame;
            hotspot.id = ID;
    ...
    value: function init(container) {
      var _get360ViewProps = (0, _ci.get360ViewProps)(container),
          marks = _get360ViewProps.marks,
          carId = _get360ViewProps.carId,
